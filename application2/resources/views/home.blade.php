                        ...
                        <tr>
                            <td>
                                ...
                                <table width="95%" border="0" align="center" cellpadding="1" cellspacing="5">
                                    ...
                                    <tr>
                                        <td width="5%" align="center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Blue_sphere.svg/768px-Blue_sphere.svg.png" title="แสดงทั้งหมด" width="29" height="29"></td>
                                        <td width="40%" style="background-color:#FFFFFF">&nbsp;<a href="">แสดงทั้งหมด    
                                                {{ Auth::user()->name }}
                                                {{ Auth::user()->surname }} </a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><img src="https://cdn.pixabay.com/photo/2014/12/21/23/30/water-drop-575495_960_720.png" title="เฉพาะที่ยังดำเนินการ" width="24" height="24"></td>
                                        <td style="background-color:#FFFFFF">&nbsp;<a href="">เฉพาะที่ยังดำเนินการ</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><img src="https://cdn.pixabay.com/photo/2012/04/10/16/49/sun-26345_960_720.png" title="สรุปค่าใช้จ่ายเสร็จสิ้น" width="24" height="24"></td>
                                        <td style="background-color:#FFFFFF">&nbsp;<a href="">สรุปค่าใช้จ่ายเสร็จสิ้น</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><img src="https://cdn.pixabay.com/photo/2016/07/05/15/27/icon-1498822_960_720.png" title="ผ่านการตรวจรับเอกสารรอการอนุมัติ" width="24" height="24"></td>
                                        <td style="background-color:#FFFFFF">&nbsp;<a href="">ผ่านการตรวจรับเอกสาร รอการอนุมัติ</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b6/Realistic_Go_Stone.svg/1024px-Realistic_Go_Stone.svg.png" title="บันทึกรายการค่าใช้จ่ายเสร็จสิ้น" width="24" height="24"></td>
                                        <td style="background-color:#FFFFFF">&nbsp;<a href="">บันทึกรายการค่าใช้จ่ายเสร็จสิ้น</a>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><img src="https://cdn.pixabay.com/photo/2012/05/07/02/46/red-47690_960_720.png" title="อยู่ในระหว่างการป้อนรายการ" width="24" height="24"></td>
        ...
        <div class="container">
            ...
            <table class="table table-striped table-dark">
                <tr bgcolor="#A3B2CC">
                    ...
                    <td width="30%" height="10" align="center" bgcolor="#2A007C" class="style4"><strong>ชื่อTrip <br></strong></td>
